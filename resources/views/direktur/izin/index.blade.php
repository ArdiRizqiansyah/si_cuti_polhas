            ...
            <div class="card">
                <div class="card-body">
                    <div class="row mb-3 justify-content-end">
                        <div class="col-md-4">
                            <form action="{{ route('direktur.izin.index') }}" method="get">
                                        ...
                                        @forelse ($izin as $index => $i )
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    @else
                                                    <button onclick="setujui('{{ route('direktur.izin.update', ['izin' => $i->id]) }}')" class="btn btn-secondary" data-bs-toggle="modal" data-bs-target="#modal-setujui">Setujui</button>
                                                    @endif
                                                </td>
                                            </tr>
                                        @empty
