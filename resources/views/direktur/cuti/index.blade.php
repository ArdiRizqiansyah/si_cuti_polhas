            ...
            <div class="card">
                <div class="card-body">
                    <div class="row mb-3 justify-content-end">
                        <div class="col-md-4">
                            <form action="{{ route('direktur.cuti.index') }}" method="get">
                                        ...
                                        @forelse ($cuti as $index => $c )
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    @else
                                                    <button onclick="potongan('{{ route('direktur.cuti.potongan', ['cuti' => $c->id]) }}', {{ $c->potongan }})" class="btn btn-primary mb-1" data-bs-toggle="modal" data-bs-target="#modal-potongan">Atur Saldo Terpotong</button>
                                                    <button onclick="setujui('{{ route('direktur.cuti.update', ['cuti' => $c->id]) }}')" class="btn btn-secondary" data-bs-toggle="modal" data-bs-target="#modal-setujui">Setujui</button>
                                                    @endif
                                                </td>
                                            </tr>
                                        @empty
