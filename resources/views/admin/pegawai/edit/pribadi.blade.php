...
@section('content-profile')
    <form action="{{ route('admin.pegawai.update.pribadi', ['id' => $profile->id]) }}" method="POST" enctype="multipart/form-data">
        @method('put')
        @csrf
        <div class="card">
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="bpjs_ket" id="bpjs_ket" class="form-control" value="{{ old('bpjs_ket', $profile->no_bpjs_ketenagakerjaan) }}" required>
                </div>
                <div class="form-group">
