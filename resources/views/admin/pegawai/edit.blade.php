                ...
                <div class="card-body">
                    <form action="{{ route('admin.pegawai.update', $pegawai->id) }}" method="post">
                        ...
                        <div class="form-group">
                            ...
                            @enderror
                            <input type="text" name="nrp" id="nrp" class="form-control @error('nrp') is-invalid @enderror" value="{{ old('nrp', $pegawai->nrp) }}">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            @enderror
                            <input type="text" name="username" id="username" class="form-control @error('username') is-invalid @enderror" value="{{ old('username', $pegawai->user->username) }}">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <select name="unit_id" id="unit_id" class="choices form-select" required>
                                @foreach ($units as $unit)
                                    <option value="{{ $unit->id }}" value="{{ old('unit_id', $pegawai->pegawaiUnit->unit_id) == $unit->id ? 'selected' : '' }}">{{ $unit->nama }}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" name="tgl_pkwt_1" id="tgl_pkwt_1" class="form-control" value="{{ old('tgl_pkwt_1', $pegawai->tgl_kontrak_pkwt_1) }}">
                        </div>
                        <div class="form-group">
                            <label for="tgl_pkwt_2" class="form-label">Tanggal Kontrak PKWT 2</label>
                            <input type="date" name="tgl_pkwt_2" id="tgl_pkwt_2" class="form-control" value="{{ old('tgl_pkwt_2', $pegawai->tgl_kontrak_pkwt_2) }}">
                        </div>
                        <div class="form-group">
                            <label for="tgl_sk" class="form-label">Tanggal SK Tetap</label>
                            <input type="date" name="tgl_sk" id="tgl_sk" class="form-control" value="{{ old('tgl_sk', $pegawai->tgl_sk_tetap) }}">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" name="tgl_lahir" id="tgl_lahir" class="form-control" value="{{ old('tgl_lahir', $pegawai->tanggal_lahir) }}">
                        </div>
                        <div class="form-group">
                            <a for="jk" class="form-label">Jenis Kelamin</a>
                            <div class="col">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="jk" id="lk" value="Laki-laki" {{ old('jk', $pegawai->jenis_kelamin) == 'Laki-laki' ? 'checked' : '' }}>
                                    <label class="form-check-label" for="lk">Laki-laki</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="jk" id="pr" value="Perempuan" {{ old('jk', $pegawai->jenis_kelamin) == 'Perempuan' ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="kk" id="kk" class="form-control" value="{{ old('kk', $pegawai->no_kk) }}">
                        </div>
                        <div class="form-group">
                            <label for="alamat" class="form-label">Alamat</label>
                            <textarea name="alamat" id="alamat" class="form-control" cols="30" rows="3">{{ old('alamat', $pegawai->alamat) }}</textarea>
                        </div>
                        <div class="form-group">
                            ...
                            <select name="status_nikah" id="status_nikah" class="form-select">
                                <option value="1" {{ old('status_nikah', $pegawai->status_perkawinan == 1 ? 'selected' : '') }}>Belum Kawin</option>
                                <option value="2" {{ old('status_nikah', $pegawai->status_perkawinan == 2 ? 'selected' : '') }}>Kawin</option>
                                <option value="3" {{ old('status_nikah', $pegawai->status_perkawinan == 3 ? 'selected' : '') }}>Cerai Hidup</option>
                                <option value="4" {{ old('status_nikah', $pegawai->status_perkawinan == 4 ? 'selected' : '') }}>Cerai Mati</option>
                            </select>
                        </div>
                        <div class="form-group">
                            <label for="jum_anak" class="form-label">Jumlah Anak</label>
                            <input type="number" name="jum_anak" id="jum_anak" class="form-control" value="{{ old('jum_anak', $pegawai->jumlah_anak) }}">
                        </div>
                        <div class="form-group">
                            <label for="pen_akhir" class="form-label">Pendidikan Terakhir</label>
                            <input type="text" name="pen_akhir" id="pen_akhir" class="form-control" value="{{ old('pen_akhir', $pegawai->pendidikan_terakhir) }}">
                        </div>
                        <div class="form-group">
                            <label for="gelar" class="form-label">Gelar</label>
                            <input type="text" name="gelar" id="gelar" class="form-control" value="{{ old('gelar', $pegawai->gelar) }}">
                        </div>
                        <div class="form-group">
                            ...
                            <select name="agama" id="agama" class="form-select">
                                ...
                                <option value="3" {{ old('agama', $pegawai->agama) == 3 ? 'selected' : '' }}>Hindu</option>
                                <option value="4" {{ old('agama', $pegawai->agama) == 4 ? 'selected' : '' }}>Budha</option>
                                <option value="5" {{ old('agama', $pegawai->agama) == 5 ? 'selected' : '' }}>Konghucu</option>
                            </select>
                        </div>
                        <div class="form-group">
                            <label for="wa" class="form-label">No Wa</label>
                            <input type="text" name="wa" id="wa" class="form-control" value="{{ old('wa', $pegawai->no_wa) }}">
                        </div>
                        <div class="form-group">
                            <label for="ibu_kan" class="form-label">Nama Ibu Kandung</label>
                            <input type="text" name="ibu_kan" id="ibu_kan" class="form-control" value="{{ old('ibu_kan', $pegawai->nama_ibu_kandung) }}">
                        </div>
                        <div class="form-group">
                            <label for="ayah_kan" class="form-label">Nama Ayah Kandung</label>
                            <input type="text" name="ayah_kan" id="ayah_kan" class="form-control" value="{{ old('ayah_kan', $pegawai->nama_ayah_kandung) }}">
                        </div>
                        <div class="form-group">
                            <label for="ibu_mer" class="form-label">Nama Ibu Mertua</label>
                            <input type="text" name="ibu_mer" id="ibu_mer" class="form-control" value="{{ old('ibu_mer', $pegawai->nama_ibu_mertua) }}">
                        </div>
                        <div class="form-group">
                            <label for="ayah_mer" class="form-label">Nama Ayah Mertua</label>
                            <input type="text" name="ayah_mer" id="ayah_mer" class="form-control" value="{{ old('ayah_mer', $pegawai->nama_ayah_mertua) }}">
                        </div>
                        <div class="form-group">
                            <label for="jen_pangkat" class="form-label">Jenjang Kepangkatan</label>
                            <input type="text" name="jen_pangkat" id="jen_pangkat" class="form-control"value="{{ old('jen_pangkat', $pegawai->jenjang_kepangkatan) }}" >
                        </div>
                        <div class="form-group">
                            <label for="npwp" class="form-label">NPWP</label>
                            <input type="text" name="npwp" id="npwp" class="form-control" value="{{ old('npwp', $pegawai->npwp) }}">
                        </div>
                        <div class="form-group">
                            <label for="nidn" class="form-label">NIDN</label>
                            <input type="text" name="nidn" id="nidn" class="form-control" value="{{ old('nidn', $pegawai->nidn) }}">
                        </div>
                        <div class="form-group">
                            <label for="bjps_ket" class="form-label">Nomor BPJS Ketenagakerjaan</label>
                            <input type="text" name="bjps_ket" id="bjps_ket" class="form-control" value="{{ old('bpjs_ket', $pegawai->bjps_ketenagakerjaan) }}">
                        </div>
                        <div class="form-group">
                            <label for="bpjs_kes" class="form-label">Nomor BPJS Kesehatan</label>
                            <input type="text" name="bpjs_kes" id="bpjs_kes" class="form-control" value="{{ old('bpjs_kes', $pegawai->bpjs_kesehatan) }}">
                        </div>
                        <div class="form-group">
                            <label for="dok_1" class="form-label">Dokter Paskes Tingkat 1</label>
                            <input type="text" name="dok_1" id="dok_1" class="form-control" value="{{ old('dok_1', $pegawai->dokter_paskes_tingkat_1) }}">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="an" id="an" class="form-control" value="{{ old('an', $pegawai->an) }}">
                        </div>
                        <div class="form-group">
                            <label for="norek" class="form-label">Nomor Rekening</label>
                            <input type="text" name="norek" id="norek" class="form-control" value="{{ old('norek', $pegawai->no_rekening) }}">
                        </div>
